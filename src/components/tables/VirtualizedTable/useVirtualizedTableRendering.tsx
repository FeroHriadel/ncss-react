 ...
 * 
 * VIRTUALIZATION HOOK
 * This hook implements TanStack Virtual-inspired virtualization with native browser scrolling.
 * 
 * KEY CONCEPTS:
 * - Only renders visible rows + overscan (e.g., 10 visible + 5 top + 5 bottom = 20 rows)
 * - Each row is absolutely positioned using transform: translateY()
 * - Native scrolling (scrollTop) triggers recalculation of which rows are visible
 * - Dynamic row heights measured on render using getBoundingClientRect()
 * 
 * SCROLL METHODS:
 * - Mousewheel: Direct scrollTop manipulation
 * - Keyboard: Direct scrollTop manipulation (ArrowUp/Down, PageUp/Down, Home/End)
 * - Scrollbar drag: Converts drag position to scrollTop
 * - Table drag: Converts mouse delta to scrollTop/scrollLeft
 * 
 * ALL SCROLLING USES NATIVE BROWSER SCROLL - NO CUSTOM SCROLL SIMULATION!
 */
